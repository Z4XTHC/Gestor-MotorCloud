      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-20">
          <div>
            ...
            <p className="text-lg text-neutral-600 mb-6 leading-relaxed">
              ...
              la excelencia y el compromiso con nuestros clientes nos impulsa
              cada día.
            </p>
            <p className="text-lg text-neutral-600 mb-8 leading-relaxed">
              Trabajamos con todas las marcas y modelos, ofreciendo soluciones
              personalizadas que se adaptan a las necesidades específicas de
              cada vehículo y cliente.
            </p>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {equipo.map((miembro) => (
              <article key={miembro.id} className="text-center group">
