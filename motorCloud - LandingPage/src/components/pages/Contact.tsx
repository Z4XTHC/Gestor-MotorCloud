  ...
  const contactInfo = [
    {
      icon: MapPin,
      label: "Dirección",
      value: `${empresa?.direccion || "Cargando..."}, ${empresa?.ciudad || "Cargando..."}, ${empresa?.provincia || "Cargando..."}`,
      link: `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(
        `${empresa?.direccion || "Cargando..."}, ${empresa?.ciudad || "Cargando..."}, ${empresa?.provincia || "Cargando..."}`,
      )}`,
    },
    {
      icon: Phone,
      label: "Teléfono",
      value: empresa?.telefono || "Cargando...",
      link: `tel:${empresa?.telefono || ""}`,
    },
    {
      icon: Mail,
      label: "Email",
      value: empresa?.email || "Cargando...",
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div>
            ...
            <div className="bg-orange-500 text-white rounded-xl p-8">
              ...
              <a
                href={`https://wa.me/+549${empresa?.telefono || ""}?text=${encodeURIComponent("Hola! Quiero consultar por un presupuesto para mi vehículo. ¿Podrían darme más información?")}`}
                target="_blank"
          ...
          <div className="rounded-xl overflow-hidden shadow-lg h-[500px]">
            <iframe
              ...
              title={`Ubicación de ${empresa?.razonSocial || "Cargando..."} en ${empresa?.ciudad || "Cargando..."}, ${empresa?.provincia || "Cargando..."}`}
            />
          </div>
        </div>
      </div>
