...
import { Car, User, Calendar, Plus, Trash2 } from "lucide-react";
            ...
            <div>
              ...
              <div className="space-y-2 mb-4">
                {selectedParts.map((part) => (
                  <div
                    key={part.id}
                    className="flex items-center gap-4 p-3 bg-neutral-50 dark:bg-neutral-700 rounded-lg"
                  >
